...
import { catchError, first, interval, Subscription, throwError } from 'rxjs';
...
@Component({
  selector: 'app-brands',
  standalone: true,
  imports: [NgClass,FilterComponent, NgFor, NgIf, MatDialogModule, MatButtonModule, NgClass],
...
export class BrandsComponent {
  ...
  ngOnInit(): void {
    this.apiService.isLoading$.subscribe((isLoading: boolean) => {
